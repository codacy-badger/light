...
void resize_if_needed (Byte_Buffer* bb, int ahead = 0) {
	while ((bb->size + ahead) >= bb->capacity) {
		bb->capacity *= 2;
		auto _tmp = (uint8_t*) realloc(bb->data, bb->capacity);
		if (_tmp) {
...
Byte_Buffer::Byte_Buffer (size_t initial_capacity) {
	this->data = (uint8_t*) malloc(initial_capacity);
...
void Byte_Buffer::append_u16 (uint16_t value) {
	...
	this->data[this->size++] = value >> 8;
	this->data[this->size++] = value;
}

void Byte_Buffer::append_u32 (uint32_t value) {
	resize_if_needed(this, 4);
	this->data[this->size++] = value >> 24;
	this->data[this->size++] = value >> 16;
	this->data[this->size++] = value >> 8;
	this->data[this->size++] = value;
}
...
void Byte_Buffer::append_u64 (uint64_t value) {
	...
	this->data[this->size++] = value >> 56;
	this->data[this->size++] = value >> 48;
	this->data[this->size++] = value >> 40;
	this->data[this->size++] = value >> 32;
	this->data[this->size++] = value >> 24;
	this->data[this->size++] = value >> 16;
	this->data[this->size++] = value >> 8;
	this->data[this->size++] = value;
