...
struct Bytecode_Generator : Pipe {
    ...
    size_t gen (Ast_Expression* exp, vector<Instruction*>* bytecode, size_t reg, bool address = false);
	...
	size_t gen (Ast_Ident* ident, vector<Instruction*>* bytecode, size_t reg, bool address = false);
